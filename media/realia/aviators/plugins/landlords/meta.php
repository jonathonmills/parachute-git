                ...
                <ul>
                    <?php foreach ($properties as $property): ?>
                        <?php if (!empty($property->post_title)): ?>
                            <li><a href="<?php print get_edit_post_link($property->ID); ?>"><?php print $property->post_title; ?></a> | <a href="<?php print get_permalink($property->ID); ?>"><?php print __('View on front end', 'aviators'); ?></a></li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ul>
            <?php else: ?>
