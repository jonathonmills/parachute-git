...
function aviators_properties_property_edit($id = NULL, $values) {
  ...
  update_post_meta($id, '_property_meta_fields', array(
    '_property_id', '_property_title', '_property_landlord', '_property_agencies', '_property_agents', '_property_custom_text', 
    '_property_price', '_property_price_suffix',  '_property_bathrooms', '_property_hide_baths', '_property_hide_beds', '_property_area', 
    '_property_latitude', '_property_longitude', '_property_featured', '_property_reduced', '_property_slider_image',  '_property_slides'
  ));
