...
add_action('aviators_before_page_render', 'aviators_property_enquire_mail');

function aviators_property_enquire_mail() {

    if (is_array($_POST) && !empty($_POST['post_id']) && isset($_POST['form_id']) && $_POST['form_id'] == 'enquire-form') {
